...
--
-- INSERT IGNORE INTO `users` VALUES ('user', '{noop}User12345@U', '1');
-- INSERT IGNORE INTO `authorities` VALUES ('user', 'read');
--
-- INSERT IGNORE INTO `users` VALUES ('admin', '{bcrypt}$2a$12$CGTLBP6igN3rfkgMkCQAD.ECrvM0FIcfLYBPEXbvFoSAnkSnqaf9C', '1');
...
-- VALUES
--     ('happy@example.com', '{noop}User12345@U', 'read'),
--     ('admin@example.com', '{bcrypt}$2a$12$CGTLBP6igN3rfkgMkCQAD.ECrvM0FIcfLYBPEXbvFoSAnkSnqaf9C', 'admin');
--
